...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-nova-vue-select', __webpack_require__(3));
    Vue.component('detail-nova-vue-select', __webpack_require__(6));
    Vue.component('form-nova-vue-select', __webpack_require__(9));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_laravel_nova__ = __webpack_require__(15);
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 3:
                                initial = _.find(this.values, function (o) {
                                    return o.value === parseInt(_this.field.value);
                                });
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                ...
                                options = [];
                                _context2.next = 4;
                                return Nova.request().get('/nova-api/' + this.field.resource, {
                                    params: {
                                        perPage: 100
                                    }
                                });
                            ...
                            case 5:
                                ...
                                values = response.data.resources.map(function (r) {
                                    var label = _.find(r.fields, function (f) {
                                        return f.attribute === _this2.resourceLabel;
                                    });
                                    var value = _.find(r.fields, function (f) {
                                        return f.attribute === _this2.resourceValue;
                                    });
                                ...
                                _context2.next = 11;
                                return Nova.request().get(response.data.next_page_url, {
                                    params: {
        ...
        [
          _c("multiselect", {
            ...
            attrs: {
              ...
              label: "label",
              "track-by": "value",
              placeholder: _vm.__("Choose an option"),
              selectLabel: _vm.__("Press enter to select"),
              selectGroupLabel: _vm.__("Press enter to select group"),
              selectedLabel: _vm.__("Selected"),
              deselectLabel: _vm.__("Press enter to remove"),
              deselectGroupLabel: _vm.__("Press enter to deselect group")
            },
            model: {
              value: _vm.value,
              callback: function($$v) {
...
var update = __webpack_require__(25)("fb94945a", content, false, {});
